...
class _ReportsPageState extends State<ReportsPage> {
  final CollectionReference reportsRef = FirebaseFirestore.instance.collection("results");
        ...
        children: [
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Your Assessment Reports', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                        Text('View, download and share your Rooftop Rain Water Harvesting reports', style: TextStyle(color: Colors.grey)),
                      ],
                    ),
                  ),
                ],
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              stream: reportsRef.orderBy("timestamp", descending: true).snapshots(),
                  ...
                  return const Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 16),
                        Text('No Reports Yet', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.grey)),
                        SizedBox(height: 8),
                        Text('Complete an assessment to generate your first report!', textAlign: TextAlign.center, style: TextStyle(fontSize: 16, color: Colors.grey)),
                      ],
                    ),
                  );
                }
  ...
  return !data.containsKey('userId') || data['userId'] == user?.uid;
}).toList();
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      ...
                      elevation: 2,
                      child: ListTile(
                        title: Text(report['structure'] ?? "Water Harvesting Report", style: const TextStyle(fontWeight: FontWeight.bold)),
